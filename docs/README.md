...
7. Сделан Middleware между клиентом и http-сервером, который логирует поступающие запросы.
...
9. Создан Makefile, показывающий основной функционал сервиса;
10. Существует взаимодействие с посторонним сервисом loms (см. в репозитории с аналогичном названии) по grpc (не http!).
...
## 1. Добавить товар в корзину.
   ...
   * Добавляется запрос в loms.StocksInfo для валидации кол-ва стоков (не реализовано).
